  ...
  return (
    ...
    <div>
      ...
      <MoreInfoButton
          ...
          content={<div>
                    <p>Here I'm using a TensorFlow.js face mesh model to detect key points on the face, that includes the corners of the mouth. </p>
                    <p>By calculating a simple ratio between the distance of these points, I can determine if the mouth is open or closed. </p>
                    <p>The "Show Landmarks" button displays these points on the image for visual reference. Try catching as much junk food as you can !</p>
